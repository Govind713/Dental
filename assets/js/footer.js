  ...
  const footerHTML = `
    ...
    <footer class="site-footer bg-dark text-white pt-5">
        <div class="container">
            <div class="row gy-4">
                <div class="col-md-4">
                    <h5 class="mb-2 footer-links">Anupam Dental</h5>
                    <p class="text-muted small">Dr. Anoop's Anupam Dental </p>
                    <p class="text-muted small">Dr. Anoop's Anupam Dental .</p>
                    <p class="text-muted small">Dr. Anoop's Anupam Dental .</p>
                    <p class="text-muted small">Dr. Anoop's Anupam Dental </p>
                ...
                <div class="col-md-3">
                    ...
                    Email: <a href="mailto:info@anupamdentalclinic.com" class="text-muted">info@anupamdentalclinic.com</a><br>
                    Address: 123 Dental Street, City
                    </address>
                    <div class="mt-2">
                ...
                <div class="col-md-2">
                    <h6>Newsletter</h6>
                    <form id="newsletterFormFooter" class="d-flex">
                        <input type="email" id="newsletterEmailFooter" class="form-control form-control-sm me-2" placeholder="Your email">
                        <button class="btn btn-primary btn-sm" id="newsletterBtnFooter" type="submit">Join</button>
                    </form>
                    <div id="newsletterFeedbackFooter" class="mt-2 small text-success d-none">Thanks — you're subscribed.</div>
                </div>
            </div>
